...
class GoodsListView2 extends React.Component {
  ...
  render() {
    console.log('111',this.props.channel);
    let index = 0;
    ...
    const row = (rowData, sectionID, rowID) => {
      ...
      return (
        <div key={rowID}>
          <HotListResultItem dataCoupon={item} turnToGoodsDetail={this.turnToGoodsDetail} catId={this.props.catId}/>
